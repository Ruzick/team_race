...
class PyTux:
    _singleton = None #allows you to create just one instance of a class
                      #leading underscore just means the variable is private in python 
    ...
    def __init__(self, screen_width=128, screen_height=96):
        ...
        self.config = pystk.GraphicsConfig.hd()  #configure supertuxkart
    ...
    def _point_on_track(distance, track, offset=0.0):
        ...
        #path_distance is the distance down the track of each line segment 
        #path_nodes is the center line of the drivable area as line segments of the 3D coordinate 
